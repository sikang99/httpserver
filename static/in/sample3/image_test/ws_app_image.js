...
function saveFile(message) {
	console.log('savefile '+ message.binaryData.length + ' bytes');

	fs.writeFile('./img_'+ (++index) +'.jpg', message.binaryData, function(err) {
		console.log('saveFile completed (./img_'+ (index) +'.jpg)');
	});
};
